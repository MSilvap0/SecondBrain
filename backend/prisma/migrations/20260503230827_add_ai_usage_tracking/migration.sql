...
CREATE TABLE "new_User" (
    ...
    "aiTokensLimit" INTEGER NOT NULL DEFAULT 10000,
    "chatMessagesCount" INTEGER NOT NULL DEFAULT 0,
    "usageResetAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
);
INSERT INTO "new_User" ("createdAt", "email", "emailVerified", "hasCompletedOnboarding", "id", "ideasCount", "ideasLimit", "name", "password", "plan", "planExpiresAt", "updatedAt", "verificationCode", "verificationExpiry") SELECT "createdAt", "email", "emailVerified", "hasCompletedOnboarding", "id", "ideasCount", "ideasLimit", "name", "password", "plan", "planExpiresAt", "updatedAt", "verificationCode", "verificationExpiry" FROM "User";
DROP TABLE "User";
